...
public class BuscarHorarios implements Task {
    ...
    public BuscarHorarios(String categoria, String caracteristica, String valor, String marca) {
    ...
    public static Performable elemento(String categoria, String caracteristica, String valor, String marca) {
        return instrumented(BuscarHorarios.class, categoria, caracteristica, valor, marca);
    }
